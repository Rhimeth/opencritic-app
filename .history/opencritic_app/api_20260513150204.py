...
def get_analytics_stats(
    ...
    # Start with the full dataset (but we already have 'primary_genre')
    filtered = df.copy()

    # Apply filters with fuzzy (contains) matching
    if developer:
    ...
    # If filtered is empty, return empty stats
    if filtered.empty:
        return {
            "yearly_scores": {},
            "genre_scores": {},
    ...
    # 2. Scores by genre (primary genre)
    ...
    # 6. Series / franchises (simple heuristic)
